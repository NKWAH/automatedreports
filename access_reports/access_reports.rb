...
#If all the scripts were in uploaded in the appropriate folders, you could run this with:
#rails runner "nick_reporting/access_reports/access_reports.rb" "2020-04-01" "2020-12-31" 3 "Redox" "large" "plus" "stub" "csv"
